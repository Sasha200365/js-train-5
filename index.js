...
'modifyArray([1, "two", 3, "four", 5])', modifyArray([1, "two", 3, "four", 5]); // Виведе 1,two,,four,5
...
function printUppercase(array) {
  ...
  let textUp;
  for (textUp of array) {
    textUp = array.toString();
    textUp = textUp.toUpperCase();
  }
  console.log(textUp);
...
function printStrings(array) {
  ...
  let reprep;
  for (reprep of array) {
    reprep = array.toString();
    reprep = reprep.trim();
    reprep = reprep.repeat(2);
  }
  console.log(reprep);
}
